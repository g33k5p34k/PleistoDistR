...
#' @export
pleistoshape_perimeter <- function (intervalfile,points,epsg) {
  intervalfile <- read.csv(intervalfile)
  points = sf::st_read(points,fid_column_name="FID")
...
#' @export
pleistoshape_area <- function (intervalfile,points,epsg) {
  intervalfile <- read.csv(intervalfile)
  points = sf::st_read(points,fid_column_name="FID")
...
#' @export
pleistoshape_surfacearea <- function (intervalfile,points,epsg) {
  intervalfile <- read.csv(intervalfile)
  points = sf::st_read(points,fid_column_name="FID")
